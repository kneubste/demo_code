 ...
 * Variables
 *****************************************************************************/
bool MEAS_data_wire = false;			///< Allow for wire data displaying
bool MEAS_data_cable = false;			///< Allow for cable data displaying
bool MEAS_data_angle = false;			///< Allow for angle data displaying
